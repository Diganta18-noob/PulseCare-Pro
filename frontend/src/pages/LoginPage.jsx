  ...
  return (
    <div className="min-h-screen flex overflow-hidden relative">
      ...
      <motion.div
        ...
        style={{
          background:
            "linear-gradient(135deg, #0c1222 0%, #0a1628 50%, #0d1117 100%)",
        }}
      ...
      >
        ...
        <div className="relative z-10">
          ...
          >
            <motion.div
              className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-500 via-cyan-400 to-emerald-400 flex items-center justify-center shadow-lg shadow-blue-500/30"
        ...
        <div className="relative z-10 space-y-8">
          ...
          >
            Join thousands of healthcare professionals using PulseCare Pro to
        ...
        <div className="relative z-10 pt-10 border-t border-white/[0.08] flex gap-12">
          {[
            ...
            >
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-white/5 to-white/10 flex items-center justify-center border border-white/10">
      ...
      <div className="flex-1 flex items-center justify-center p-6 relative">
        <motion.div
          className="absolute top-0 right-0 w-[500px] h-[500px] rounded-full bg-gradient-to-br from-blue-600/8 to-purple-600/5 blur-[120px] pointer-events-none"
          animate={{
            scale: [1, 1.2, 1],
            opacity: [0.4, 0.6, 0.4],
          }}
        ...
        >
          ...
          <div className="lg:hidden text-center mb-12">
            <motion.div
              className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-600 via-cyan-500 to-emerald-400 mb-5 shadow-xl shadow-blue-500/25"
          ...
          <form onSubmit={handleSubmit} className="space-y-7">
            ...
            >
              ...
              <div className="relative group">
                <motion.div className="absolute inset-0 rounded-xl bg-gradient-to-r from-blue-500/20 to-purple-500/20 opacity-0 group-focus-within:opacity-100 transition-opacity duration-300 blur" />
                <div className="relative">
                  <Mail
                    className={`absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 z-20 transition-all duration-300 ${focused === "email" ? "text-blue-400 scale-110" : "text-white/25"}`}
                  />
                  <input
                    type="email"
                    value={email}
            ...
            >
              <div className="flex justify-between items-center ml-1">
                ...
                <button
                  type="button"
                  className="text-sm text-blue-400/70 hover:text-blue-400 font-medium transition-colors"
                >
                  Forgot password?
                </button>
              </div>
              <div className="relative group">
                <motion.div className="absolute inset-0 rounded-xl bg-linear-to-r from-blue-500/20 to-purple-500/20 opacity-0 group-focus-within:opacity-100 transition-opacity duration-300 blur" />
                <div className="relative">
                  <Lock
                    className={`absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 z-20 transition-all duration-300 ${focused === "password" ? "text-blue-400 scale-110" : "text-white/25"}`}
                  />
                  <input
                    type="password"
                    value={password}
          ...
          >
            ...
            <span className="text-[10px] text-white/25 uppercase tracking-[0.2em] font-semibold">
              Quick Demo Access
            </span>
            <div className="flex-1 h-px bg-gradient-to-r from-transparent via-white/[0.1] to-transparent" />
          </motion.div>
          ...
          <div className="grid grid-cols-3 gap-4">
            {demos.map((d, i) => (
              ...
              >
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${d.grad} opacity-0 group-hover:opacity-[0.15] transition-opacity duration-500`}
                />
                <div className="relative">
                  <motion.div
                    className={`w-10 h-10 mx-auto mb-3 rounded-xl bg-gradient-to-br ${d.grad} flex items-center justify-center shadow-lg ${d.glow}`}
                    whileHover={{ rotate: 15, scale: 1.1 }}
                    transition={{ type: "spring", stiffness: 400 }}
                  >
                    <d.icon className="w-5 h-5 text-white" />
                  </motion.div>
                  <p className="text-xs font-semibold text-white/40 group-hover:text-white transition-colors">
                    {d.role}
                  </p>
                </div>
              </motion.button>
